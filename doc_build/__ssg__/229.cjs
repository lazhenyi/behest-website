...
exports.ids = ["229"];
exports.modules = {
8708(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
    ...
    return (0,react_jsx_runtime__rspack_import_0.jsxs)(react_jsx_runtime__rspack_import_0.Fragment, {
        children: [
            ...
            (0,react_jsx_runtime__rspack_import_0.jsx)(_components.p, {
                children: "本文档提供了 behest 中主要类型和 traits 的快速参考。"
            }),
            "\n",
...
MDXContent.__RSPRESS_PAGE_META["zh%2Fapi-reference.md"] = {
    "toc": [
        {
            "id": "核心-traits",
            "text": "核心 Traits",
