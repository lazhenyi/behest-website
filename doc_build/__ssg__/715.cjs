...
exports.ids = ["715"];
exports.modules = {
118(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
        ...
        children: [
            ...
            (0,react_jsx_runtime__rspack_import_0.jsxs)(_components.p, {
                children: [
                    ...
                    " 暴露类型化的错误类别，而不是字符串化的框架失败。这使得错误处理显式化，并帮助您适当地处理不同的错误场景。"
                ]
            }),
            "\n",
...
MDXContent.__RSPRESS_PAGE_META["zh%2Ferror-handling.md"] = {
    "toc": [
        {
            "id": "错误类型",
            "text": "错误类型",
