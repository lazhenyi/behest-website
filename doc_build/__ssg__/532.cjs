...
exports.ids = ["532"];
exports.modules = {
6759(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
    ...
    return (0,react_jsx_runtime__rspack_import_0.jsxs)(react_jsx_runtime__rspack_import_0.Fragment, {
        children: [
            ...
            (0,react_jsx_runtime__rspack_import_0.jsx)(_components.p, {
                children: "工具是 behest 中的显式运行时对象。每个工具暴露一个稳定的名称、一个人类可读的描述和一个 JSON Schema 参数契约。"
            }),
            "\n",
            ...
            "\n",
            (0,react_jsx_runtime__rspack_import_0.jsx)(_components.p, {
                children: "工具会自动从其定义生成 JSON Schema。此 schema 用于提供商理解工具期望的参数。"
            }),
            "\n",
            (0,react_jsx_runtime__rspack_import_0.jsxs)(_components.h2, {
                id: "最佳实践",
...
MDXContent.__RSPRESS_PAGE_META["zh%2Ftools.md"] = {
    "toc": [
        {
            "id": "定义工具",
            "text": "定义工具",
